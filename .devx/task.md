...
mode: feature
state: pr_opened
pr_url: [](https://github.com/streamingfast/sfreleaser/pull/2)
...
| Phase 8 — PR Opened | Done | Pushed branch to origin and opened PR #2 against `master`: https://github.com/streamingfast/sfreleaser/pull/2. State set to `pr_opened`. |
